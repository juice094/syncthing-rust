...
fn bench_hello_encode(c: &mut Criterion) {
    ...
    let hello = Hello::new("device-name-32-bytes-padding-xxxx", "syncthing-rust", "0.2.0-beta");
...
criterion_group!(benches, bench_hello_encode, bench_hello_decode, bench_hello_roundtrip_sizes);
