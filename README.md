...
> - ✅ **Real-network Tailscale E2E validated** (2026-05-18): Windows 11 ↔ Ubuntu 24.04 via Tailscale (`100.107.247.38` ↔ `100.127.13.26`). BEP handshake + **bidirectional** file sync confirmed. [`docs/reports/REAL_NETWORK_DUAL_NODE_E2E_2026-05-18.md`](docs/reports/REAL_NETWORK_DUAL_NODE_E2E_2026-05-18.md).
